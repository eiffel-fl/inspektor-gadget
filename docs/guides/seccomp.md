...
```bash
$ kubectl gadget seccomp-advisor stop -n seccomp-demo jMzhur2dQjZJxDCI
{
...
```bash
$ kubectl gadget seccomp-advisor stop -n seccomp-demo TAyR9BXes6GU04rG
{
	...
}
```
...
$ kubectl apply -f docs/examples/seccomp/unconfined.yaml
pod/hello-python created
$ kubectl gadget seccomp-advisor start -n seccomp-demo -m ExternalResource --trace-output seccomp-demo/hello-profile -p hello-python
TAyR9BXes6GU04rG
